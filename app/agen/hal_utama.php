...
<body>
				...
				<div class="navbar navbar-fixed-top navbar-default">
					<div class="navbar-header">
						<a href="?menu=home" class="navbar-brand" style="margin-top: -23px;">
							<img alt="Brand" src="../images/PPOB.png" style="width: 150px ; height: 50px; position : relative; top:8px;">
						</a>
					</div>
	...
	<footer class="container-fluid bg-4 text-center">
		<p>
		  	<strong>Copyright&nbsp;&copy;&nbsp;2024 <a target="_blank" href="https://www.instagram.com/tomharrdd/">HardSu</a>.</strong>&nbsp;
		  	<br>
