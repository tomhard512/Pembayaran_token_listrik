...
<head>
    ...
    <link rel="shortcut icon" href="../images/logo_pln.png" type="image/x-icon">
    <style>
        body {
            background: url(../images/bg_pln.jpg);
				...
				<div class="col-md-6">
					<div class="panel panel-primary">
						...
						<div class="panel-footer">
							<center>
								<strong>&copy;2024 - <a  href="https://www.instagram.com/tomharrdd/">Tom Hard</a>
							</center>
						</div>
						<!-- end footer -->
					</div>
